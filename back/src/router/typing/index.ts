...
export const LOGIN_COMPONENT = () => import('@/component/login')
export const EXCEPTION_COMPONENT = () => import('@/component/exception')
export const LAYOUT_COMPONENT = () => import('@/component/layout/default/index.vue')
